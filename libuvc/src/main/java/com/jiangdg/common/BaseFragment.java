...
import com.jiangdg.dialog.MessageDialogFragment;
	...
	protected void checkPermissionResult(final int requestCode, final String permission, final boolean result) {
		...
		if (!result && (permission != null)) {
			if (Manifest.permission.RECORD_AUDIO.equals(permission)) {
				showToast(com.jiangdg.common.R.string.permission_audio);
			}
			if (Manifest.permission.WRITE_EXTERNAL_STORAGE.equals(permission)) {
				showToast(com.jiangdg.common.R.string.permission_ext_storage);
			}
			if (Manifest.permission.INTERNET.equals(permission)) {
				showToast(com.jiangdg.common.R.string.permission_network);
			}
		}
	}
	...
	protected boolean checkPermissionWriteExternalStorage() {
		if (!PermissionCheck.hasWriteExternalStorage(getActivity())) {
			MessageDialogFragment.showDialog(this, REQUEST_PERMISSION_WRITE_EXTERNAL_STORAGE,
				com.jiangdg.common.R.string.permission_title, com.jiangdg.common.R.string.permission_ext_storage_request,
	...
	protected boolean checkPermissionAudio() {
		if (!PermissionCheck.hasAudio(getActivity())) {
			MessageDialogFragment.showDialog(this, REQUEST_PERMISSION_AUDIO_RECORDING,
				com.jiangdg.common.R.string.permission_title, com.jiangdg.common.R.string.permission_audio_recording_request,
	...
	protected boolean checkPermissionNetwork() {
		if (!PermissionCheck.hasNetwork(getActivity())) {
			MessageDialogFragment.showDialog(this, REQUEST_PERMISSION_NETWORK,
				com.jiangdg.common.R.string.permission_title, com.jiangdg.common.R.string.permission_network_request,
	...
	protected boolean checkPermissionCamera() {
		if (!PermissionCheck.hasCamera(getActivity())) {
			MessageDialogFragment.showDialog(this, REQUEST_PERMISSION_CAMERA,
				com.jiangdg.common.R.string.permission_title, com.jiangdg.common.R.string.permission_camera_request,
